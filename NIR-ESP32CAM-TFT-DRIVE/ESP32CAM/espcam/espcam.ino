...
const char* ssid     = "CebelleLaptop";   //your network SSID
const char* password = "123456789";   //your network password

String myScript = "/macros/s/AKfycbwauOMgIuxKscX76fV2I9kZ9AmVtSJNJpTLV9I0Or86V_TBXh3R1jDgXfDXkWYhhnru/exec";    //Create your Google Apps Script and replace the "myScript" path.
